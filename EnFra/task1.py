...
for start in colstart:
    ...
    rs.to_csv(out_path + 'rs_' + str(end) + '.csv')
    dfa.to_csv(out_path + 'dfa_' + str(end) + '.csv')
    mfdfa.to_csv(out_path + 'mfdfa_' + str(end) + '.csv')
    genH.to_csv(out_path + 'genH_' + str(end) + '.csv')
    sampEnt.to_csv(out_path + 'sampEnt_' + str(end) + '.csv')
    wtmm_slopes_max.to_csv(out_path + 'wtmm_slopes_max_' + str(end) + '.csv')
    wtmm_slopes_mean.to_csv(out_path + 'wtmm_slopes_mean_' + str(end) + '.csv')
    wtmm_slopes_norm.to_csv(out_path + 'wtmm_slopes_norm_' + str(end) + '.csv')
    wtmm_scales_max.to_csv(out_path + 'wtmm_scales_max_' + str(end) + '.csv')
    wtmm_scales_mean.to_csv(out_path + 'wtmm_scales_mean_' + str(end) + '.csv')
    wtmm_scales_norm.to_csv(out_path + 'wtmm_scales_norm_' + str(end) + '.csv')
    wtmm_modmax_max.to_csv(out_path + 'wtmm_modmax_max_' + str(end) + '.csv')
    wtmm_modmax_mean.to_csv(out_path + 'wtmm_modmax_mean_' + str(end) + '.csv')
    wtmm_modmax_norm.to_csv(out_path + 'wtmm_modmax_norm_' + str(end) + '.csv')
    wtmm_coeffs_max.to_csv(out_path + 'wtmm_coeffs_max_' + str(end) + '.csv')
    wtmm_coeffs_mean.to_csv(out_path + 'wtmm_coeffs_mean_' + str(end) + '.csv')
    wtmm_coeffs_norm.to_csv(out_path + 'wtmm_coeffs_norm_' + str(end) + '.csv')